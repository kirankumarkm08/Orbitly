    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-background">
      ...
      <div className="w-full max-w-md mx-4 z-10 bg-card rounded-2xl border border-border shadow-xl p-8">
        ...
        <form onSubmit={handleEmailSubmit} className="space-y-5">
          ...
          <Button type="submit" loading={loading} className="w-full h-11 text-base font-semibold">
            Sign in
          </Button>

          <p className="text-center text-sm text-muted-foreground">
            Don&apos;t have an account?{' '}
            <a href="/onboarding" className="text-primary hover:underline font-medium">Create workspace</a>
          </p>
        </form>
      </div>
    </div>
